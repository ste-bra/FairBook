...
require_once(ROOT_DIR . 'lib/Application/Reservation/Validation/WaitingListAddRule.php');
require_once(ROOT_DIR . 'lib/Application/Reservation/Validation/CurrentUserOnWaitingListExcludedRule.php');
