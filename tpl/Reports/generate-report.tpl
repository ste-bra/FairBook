	...
	<form id="customReportInput">
		<div id="custom-report-input">
			...
			<div class="input-set">
				...
				<input type="radio" {formname key=REPORT_RANGE} value="{Report_Range::CURRENT_WEEK}" id="current_week" checked="checked"/>
		...
		<input type="checkbox" id="chkIncludeDeleted" {formname key=INCLUDE_DELETED}/> <label for="chkIncludeDeleted">{translate key=IncludeDeleted}</label>
		{csrf_token}
	</form>
</fieldset>
