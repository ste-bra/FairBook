...
<div id="help">
	...
	<div id="help-configuration">
		...
		<p class="setting"><span>$conf['settings']['privacy']['hide.user.details']</span>If non-administrators can view personal
			information about other users. Default is false.</p>

		<p class="setting"><span>$conf['settings']['privacy']['hide.reservation.details']</span>If non-administrators can view reservation details.
		...
		<p class="setting"><span>$conf['settings']['phpmailer']['smtp.auth']</span>SMTP requires authentication, if using smtp.
		...
		<p class="setting"><span>$conf['settings']['plugins']['PreReservation']</span>Name of pre-reservation plugin to use. For
			more on plugins, see Plugins below</p>

		<p class="setting"><span>$conf['settings']['plugins']['PostReservation']</span>Name of post-reservation plugin to use.
