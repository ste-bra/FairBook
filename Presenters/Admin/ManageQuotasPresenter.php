...
class ManageQuotasPresenter extends ActionPresenter
{
     ...
     * @param IScheduleRepository $scheduleReservationRepository
    ...
    public function __construct(IManageQuotasPage $page,
                                ...
                                IScheduleRepository $scheduleReservationRepository,
                                IQuotaViewRepository $quotaRepository)
    {
        ...
        $this->scheduleRepository = $scheduleReservationRepository;
